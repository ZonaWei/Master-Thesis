...
def zero_shot_translate(text, src_lang="Swahili", tgt_lang="English"):
    prompt = f"Translate from {src_lang} to {tgt_lang}. Only output the translation:\n{text}"
...
output_file = "llm_zero_shot_output_swh.txt"
