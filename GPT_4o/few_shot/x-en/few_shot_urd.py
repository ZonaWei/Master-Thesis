...
FEW_SHOT_PREFIX = """
Task: Translate the following Urdu sentences to English. Maintain correct tone and fluency. Follow the structure of the examples. Just respond with the translation and nothing else.

Example 1:
Urdu: لائنوں کے درمیان زیادہ فاصلہ دو۔
English: Leave more space between the lines.
...
input_file = "urd_few_shot_test.txt"
output_file = "llm_few_shot_output_urd.txt"
