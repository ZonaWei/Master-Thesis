...
Example 1:
Swahili: Nitatengeneza siagi ya njugu.
English: I'll make some peanut butter.

Example 2:
Swahili: Pia wewe ulishangaa kuniona?
English: Were you surprised to see me?

Example 3:
Swahili: Kuabudu mashujaa ni hatari.
English: Hero worship is a dangerous thing.
...
input_file = "swh_few_shot_test.txt"
output_file = "llm_few_shot_output_swh.txt"
