...
FEW_SHOT_PREFIX = """
Task: Translate the following English sentences to Swahili. Maintain correct tone and fluency. Follow the structure of the examples. Just respond with the translation and nothing else

Example 1:
English: He became deaf ringing the bells.
Swahili: Akawa kiziwi akipiga kengele.

Example 2:
English: Can we wait for them here?
Swahili: Je! Tunaweza kuwangojea hapa?

Example 3:
English: We've received all the proper paperwork.
Swahili: Tumepokea makaratasi yote yanayofaa
...
output_file = "few_shot_eng_swh.txt"
