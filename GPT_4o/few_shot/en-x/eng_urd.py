...
FEW_SHOT_PREFIX = """
Task: Translate the following English sentences to Urdu. Maintain correct tone and fluency. Follow the structure of the examples. Just respond with the translation and nothing else.

Example 1:
English: He is lying on the bench.
Urdu: وہ بینچ پہ لیٹا ہوا ہے۔

Example 2:
English: Is that black bag yours?
Urdu: کیا وہ کالا بیگ تمہارا ہے؟

Example 3:
English: She said no more work.
Urdu: اس نے کہا اور کام نہیں۔
...
output_file = "few_shot_eng_urd.txt"
