...
FEW_SHOT_PREFIX = """
Task: Translate the following English sentences to Zulu. Maintain correct tone and fluency. Just respond with the translation and nothing else.
