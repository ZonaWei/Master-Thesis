...
FEW_SHOT_PREFIX = """
Task: Translate the following English sentences to Swahili. Maintain correct tone and fluency. Just respond with the translation and nothing else.
