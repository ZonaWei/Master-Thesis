...
Example 1:
Amharic: ቦስቶን ውስጥ ለመጉብኘት ብዙ ቦታዎች አሉ።
English: There are a lot of places to visit in Boston.

Example 2: ሦስት ቋንቋዎች አልናገርም
English: I don't speak three languages.

Example 3:
Amharic: ቶም በአንበሳ ተገደለ።
English: Tom was killed by a lion.

Example 4:
Amharic: እንዲሁም ስለአቅርቦቱ ለማሰብ ወይም ለመድረሻዎ ሌሎች ሰነዶችን (ለምሳሌ፥ ቪዛ) ለማግኘት ጊዜ ካስፈለግዎ እነርሱ ቦታውን ልይዙልዎት ይችላሉ።
English: They can also hold the reservation for you if you need time to think about the offer or procure other documents for your destination (e.g. visa).
...
input_file = "amh_few_shot_with_diversity.txt"
output_file = "diversity_output_amh.txt"
