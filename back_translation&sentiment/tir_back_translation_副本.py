...
def zero_shot_translate(text, src_lang="English", tgt_lang="Tigrinya"):
    prompt = f"Translate this from {src_lang} to {tgt_lang}:\n{text}. Avoid repetition and make the output concise and clear."
...
output_file = "back_translation_tir.txt"
