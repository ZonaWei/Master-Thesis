...
Example 1:
Amharic: በራስ-ሰር ዝማኔ በኋላ ተኮ ማዋቀሩን ስትጨርስ.
English: Clear the cache.

Example 2: 
Amharic: በየቀኑ ከእግዚአብሔር ጋር በጸሎት ይንገሩ.
English: Talk to God in prayer every day.
...
input_file = "subject/no_subject_amh.txt"
output_file = "subject/no_subject_amh_output.txt"
