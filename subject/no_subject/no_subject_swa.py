...
FEW_SHOT_PREFIX = """
Task: Translate the following Swahili sentences to English. Respond with **only** the English translation. Do not add explanations or extra responses.

Example 1:
Swahili: Maliza ghasia; tafuta amani.
English: End violence; pursue peace.

Example 2:
Swahili: Chukua moja ya kwangu.
English: Take one of me.

Example 3:
Swahili: Kamata yai la dhahabu.
English: Grab the golden egg.
...
input_file = "no_subject_swa.txt"
output_file = "no_subject_swa_output.txt"
